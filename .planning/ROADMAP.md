...
| 15. Live Config Hot-Reload Fix | 0/2 | Not Started | |
...
### Phase 15: Live Config Hot-Reload Fix

**Goal:** Make all dashboard Settings changes take effect immediately by switching SafetyPipeline, ExecutionEngine, PositionManager, and index.ts from static config snapshots to getRuntimeConfig() reads at evaluation/execution time
...
Plans:
- [ ] 15-01-PLAN.md — Backend hot-reload: CONFIG_CHANGED event type, ConfigPatchSchema extension, getRuntimeConfig() refactor across SafetyPipeline, ExecutionEngine, SellLadder, PositionManager, index.ts
- [ ] 15-02-PLAN.md — Dashboard frontend: CONFIG_CHANGED feed card rendering, SSE listener, Poll Interval and Buy Slippage Settings fields
