...
Plans:
- [x] 21-01-PLAN.md — Backend controls API: SAFETY_EVALUATION emission, pause/resume, force-sell, emergency-stop (DASH-08, DASH-09)
- [x] 21-02-PLAN.md — Sidebar 6-nav foundation, controls store, page stubs, 3-state connection bar
- [x] 21-03-PLAN.md — Per-source analytics: stat cards, equity curve + table source filters (DASH-07)
- [x] 21-04-PLAN.md — Pipeline streaming view + Controls page with force-sell and emergency-stop dialog (DASH-08, DASH-09)
- [x] 21-05-PLAN.md — System Status page: health cards, RPC metrics, alert history (DASH-10)
**UI hint**: yes
...
| 21. Dashboard Overhaul | v1.1 | 5/5 | Complete    | 2026-05-26 |
