...
Phase 17: Security Fixes -- Plan 03 complete (dependency vulnerabilities resolved, BUGS.md updated).
...
| Phase 17-security-fixes P03 | 6 | 2 tasks | 3 files |
...
- Phase 17 added: security fixes (SEC-01 through SEC-04)
...
- [Phase 17-03]: bigint-buffer HIGH accepted as LOW real-world risk -- used only for RPC response deserialization, not user input; no patched version exists (patched: <0.0.0)
- [Phase 17-03]: pnpm overrides for transitive dependency vulnerabilities (picomatch, brace-expansion) -- upstream packages haven't updated yet
